            ...
            <div class="card-body pb-2">
                ...
                <div class="row mt-4">
                    <div class="col-md-12 text-center">
                        <asp:Button ID="btnCrearKit" runat="server" Text="Crear Kit" CssClass="btn btn-primary" Style="background-color: #004EA8; border-color: #004EA8;" OnClick="CrearKit_Click" />
                    </div>
                </div>
