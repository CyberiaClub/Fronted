...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex justify-content-center align-items-center vh-200" style="color: slategrey">
        <div class="card" style="width: 65%; color: midnightblue">
            ...
            <div class="card-body align-content-xxl-center align-content-center" style="font: medium">
                ...
                <div class="d-flex">
                    ...
                    <div style="width:60%">
                        <div class="col-md-30 align-content-center">
                            <div class="mb-3">
                                <label for="marcaName">Nombre de la Marca:</label>
                                <asp:TextBox ID="marcaName" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                            </div>
                        </div>
                        <div>
                            <div class="pb-3">
                    ...
                    <div class="col-md-6 text-center d-flex flex-column align-items-center justify-content-center align-content-center">
                        ...
                        <asp:Image ID="imgNuevaMarca" runat="server" CssClass="img-fluid img-thumbnail mb-3" ImageUrl="/Imagenes/marca.png" Height="45%" />
