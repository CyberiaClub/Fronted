<%@ Page Title="" Language="C#" MasterPageFile="~/Cliente/SoftCyberiaCliente.Master" AutoEventWireup="true" CodeBehind="registro_usuario.aspx.cs" Inherits="SoftCyberiaWA.Cliente.registro_usuario" %>
    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 80vh;">
        <div class="card p-4" style="width: 100%; max-width: 500px;">
            ...
            <div class="text-center mt-3">
                <a href="iniciar_sesion.aspx">¿Ya tienes cuenta? Inicia sesión</a>
            </div>
        </div>
    </div>
